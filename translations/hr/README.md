...
**Ako želite dodatne podržane jezike prijevoda, popis je [ovdje](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Ovaj tečaj sadrži lekcije koje pokrivaju osnove izrade AI Agenata. Svaka lekcija pokriva svoju temu pa počnite gdje želite!

Tečaj podržava više jezika. Pogledajte naše [dostupne jezike ovdje](#-multi-language-support).

Ako je ovo vaš prvi put da radite s Generativnim AI modelima, pogledajte naš tečaj [Generative AI For Beginners](https://aka.ms/genai-beginners) koji uključuje 21 lekciju o radu s GenAI.
...
Ako zapnete ili imate pitanja o izradi AI Agenata, pridružite se našem namjenskom Discord kanalu u [Microsoft Foundry Discordu](https://aka.ms/ai-agents/discord).
...
Za više informacija o pokretanju koda za ovaj tečaj, pogledajte [Course Setup](./00-course-setup/README.md).
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Uvod u AI Agente i njihove primjene          | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Razumijevanje AI Agent dizajnerskih obrazaca  | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Dizajnerski obrazac višestrukih agenata        | [Link](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Dizajnerski obrazac metakognicije              | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Zaštita AI agenata                           | Uskoro dostupno                               |                                                            |                                                                                        |
...
Contributor License Agreement (CLA) izjavom u kojoj potvrđujete da imate pravo i zapravo dajete
prava na korištenje vašeg doprinosa. Za detalje posjetite <https://cla.opensource.microsoft.com>.

Kada pošaljete zahtjev za povlačenje koda, CLA bot će automatski odrediti hoćete li morati dostaviti
CLA i označiti PR na odgovarajući način (npr. provjera statusa, komentar). Jednostavno slijedite upute
koje vam bot pruži. To ćete morati napraviti samo jednom za sve repozitorije u kojima koristimo CLA.
...
Korištenje Microsoftovih zaštitnih znakova ili logotipa u izmijenjenim verzijama ovog projekta ne smije stvarati zabunu ili implicirati sponzorstvo Microsofta.
